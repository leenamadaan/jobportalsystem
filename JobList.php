                            ...
                            <form id="frm" action="Registration1" method="post">
                                <table  border="0" cellspacing="20" cellpadding="8" style align="center">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="UserJobList1.php?type=HR">HR</a>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="UserJobList1.php?type=Marketing">Marketing</a>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="UserJobList1.php?type=IT">IT</a>
                                        </td>

                                    </tr>
                                    <tr>
                                        <td>
                                            <a href="UserJobList1.php?type=Accountant">Accountant</a>
                                        </td>
