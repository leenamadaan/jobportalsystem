                ...
                <td width="900"  height="500" valign="top">
                    <span style="padding-left: 20px;text-align: justify;" class="text-11" >
                        <div class="body-cont-col" style="height: 450px;overflow: auto;">
                            ...
                            <div class="head1" align="center"><strong>Job Seekers List</strong></div>
                                ...
                                <table width="900"  align="center" border="0" >
                                    ...
                                    ?>
                                        <tr align="center" bgcolor="#F9F9F9">
											...
											<td class="login-text"><a href="reply.php?id=<?php echo $row['a15']; ?>"style="color:red;text-decoration:none">Reply</a>
                                    </td>
